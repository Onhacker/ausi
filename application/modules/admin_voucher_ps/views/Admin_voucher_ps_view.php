...
$(document).ready(function(){
  voucherTable = $('#vouchertable_ps').DataTable({
  ...
  Swal.fire({
    ...
    $.ajax({
      ...
      success:function(res){
        if(res.success){
          swalToast('success','Berhasil',res.pesan || 'Voucher PS berhasil diklaim');
          refreshVoucher();
        }else{
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          ...
          <?php if ((int)$threshold > 0): ?>
            <p class="text-muted mb-2">
              Program loyalty sewa PlayStation:
          ...
          <?php else: ?>
            <p class="text-muted mb-2">
              Program voucher sewa PlayStation saat ini <b>nonaktif</b>
              (Jumlah main untuk dapat FREE diset <b>0</b> pada pengaturan).
            </p>
          <?php endif; ?>
          ...
          <div class="table-responsive">
            <table id="vouchertable_ps" class="table table-sm table-striped table-bordered w-100">
              <thead>
                <tr>
                  <th width="5%">No.</th>
                  <th>Nama Terakhir</th>
