...
<!-- Modal Detail -->
<div id="bil-paid-detail-modal" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="mymodal-title">Detail Pembayaran</h4>
...
function show_detail(id){
  ...
  $.getJSON("<?= site_url('admin_riwayat_billiard/detail/') ?>"+id)
    .done(function(r){
      ...
      $('#bil-paid-detail-modal').modal('show');
    })
