...
<!-- SVG Points Promo Banner (narrower, bigger fonts, roomy footer) -->
<div id="ptsSvgBanner" class="svg-promo" hidden>
  <!-- ====== MOBILE SQUARE (±360x360) ====== -->
  <!-- ====== MOBILE SQUARE (lebih lega, font besar, footer bertumpuk) ====== -->
<svg class="is-mobile" viewBox="0 0 360 400" width="100%" height="auto" role="dialog" aria-label="Promo poin & voucher">
  <defs>
    ...
    <linearGradient id="btnLiteM" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0%" stop-color="rgba(255,255,255,.18)"/><stop offset="100%" stop-color="rgba(255,255,255,.22)"/>
    </linearGradient>
...
<g filter="url(#shadowM)">
  ...
  <g id="btnClose" class="svg-hit" transform="translate(328,20)">
    <circle r="12" fill="rgba(255,255,255,.18)" stroke="rgba(255,255,255,.45)" stroke-width="1.5"/>
  ...
  <g transform="translate(20,28)">
    <path d="M0,20 a10,10 0 0 1 10,-10 h230 a10,10 0 0 1 10,10 v10 a10,10 0 0 0 0,22 v10 a10,10 0 0 1 -10,10 h-230 a10,10 0 0 1 -10,-10 z"
          fill="rgba(255,255,255,.18)" stroke="rgba(255,255,255,.25)"/>
...
<g transform="translate(208,38) scale(.95)">
  ...
  <!-- Headline + desc (dikasih jarak besar dari badge) -->
  <g transform="translate(20,140)">
    ...
    <!-- pecah 2 baris supaya tidak kepotong -->
    <text x="0" y="96"  fill="#ffffff" font-size="14">Pengumuman voucher & rekap poin</text>
    <text x="0" y="116" fill="#ffffff" font-size="14">
      <tspan font-weight="700">setiap tanggal 1</tspan> tiap bulan.
    </text>
  </g>

  <!-- Footer (lebih tinggi; toggle dan S&K bertumpuk, tidak mepet) -->
 <g transform="translate(16,292)">
    <rect x="0" y="0" rx="12" ry="12" width="328" height="72" fill="rgba(255,255,255,.10)" stroke="rgba(255,255,255,.18)"/>
    <g id="toggleNoShow" class="svg-hit" transform="translate(12,22)">
      <rect x="0" y="-11" rx="9" ry="9" width="24" height="24" fill="url(#btnLiteM)" stroke="rgba(255,255,255,.4)"/>
    ...
    <g id="btnOK" class="svg-btn svg-hit" transform="translate(252,16)">
      <rect x="0" y="0" rx="12" ry="12" width="64" height="40" fill="url(#btnLiteM)" stroke="rgba(255,255,255,.4)"/>
  ...
  <!-- ====== DESKTOP WIDE (tetap seperti versi lega) ====== -->
  <svg class="is-desktop" viewBox="0 0 820 260" width="100%" height="auto" role="dialog" aria-label="Promo poin & voucher">
    <defs>
  ...
  <ellipse cx="0" cy="8" rx="12" ry="5" fill="url(#goldD)"/>
    ...
    <g id="btnClose" class="svg-hit" transform="translate(774,18)">
      <circle r="13" fill="rgba(255,255,255,.18)" stroke="rgba(255,255,255,.45)" stroke-width="1.5"/>
      <path d="M -5,-5 L 5,5 M -5,5 L 5,-5" stroke="#fff" stroke-width="2.4" stroke-linecap="round"/>
    </g>
...
<g transform="translate(232,44)">
  ...
  <use href="#coinD" opacity=".85" transform="translate(28,0)">
    ...
    <g transform="translate(24,120)">
      ...
      <text x="0" y="56" fill="#ffffff" font-size="14">
        Pengumuman voucher & rekap poin <tspan font-weight="700">setiap tanggal 1</tspan> tiap bulan.
      </text>
    </g>

  <!-- ===== DESKTOP footer (rapi & center) ===== -->
<g transform="translate(20,204)" id="footerDesktop">
  <!-- footer bar: sedikit lebih tinggi supaya lega -->
  <rect x="0" y="0" rx="12" ry="12" width="780" height="52"
        fill="rgba(255,255,255,.10)" stroke="rgba(255,255,255,.18)"/>

  <!-- S&K (kiri, baseline pas) -->
  <g id="linkTerms" class="svg-link" transform="translate(12,34)">
    <text x="0" y="0" fill="#ffffff" font-size="14" text-decoration="underline">
      Syarat & Ketentuan berlaku
    </text>
  </g>

  <!-- Toggle (tengah, centered) -->
  <g id="toggleNoShow" class="svg-hit" transform="translate(356,30)">
    <rect x="0" y="-13" rx="10" ry="10" width="26" height="26"
          fill="url(#btnLiteD)" stroke="rgba(255,255,255,.4)"/>
    <path id="chkMark" d="M5,1 L11,8 L21,-8" stroke="#fff" stroke-width="3"
  ...
  <!-- OK (kanan, margin 8px dari tepi; vertikal center) -->
  <g id="btnOK" class="svg-btn svg-hit" transform="translate(700,6)">
    <!-- 700 = 780 - 72 (btn width) - 8 (margin) -->
    <rect x="0" y="0" rx="14" ry="14" width="72" height="40"
          fill="url(#btnLiteD)" stroke="rgba(255,255,255,.4)"/>
...
(function(){
  ...
  var svg  = svgs.find(s => getComputedStyle(s).display !== 'none') || svgs[0];
