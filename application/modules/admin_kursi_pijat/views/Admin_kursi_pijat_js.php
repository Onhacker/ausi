...
function add(){
  ...
  updateEstimator();
  $('#id_transaksi').val('');
  $('input[name="status"][value="baru"]').prop('checked', true); // default radio
...
function bayar(id){
  Swal.fire({
    title: 'Tandai Lunas?', text: 'Status akan diubah menjadi Lunas.',
...
function hapus_data(){
  ...
  Swal.fire({
    title: 'Hapus data terpilih?', text: 'Tindakan ini tidak bisa dibatalkan.',
